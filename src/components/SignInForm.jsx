  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          flex: '0 0 45%',
          background: 'linear-gradient(135deg, #4361ee 0%, #af1dca 50%, #f107a3 100%)',
          position: 'relative',
          display: 'flex',
          ...
          <div style={{ textAlign: 'center', zIndex: 1, width: '100%' }}>
            ...
            <div style={{ position: 'relative', width: '320px', height: '300px', margin: '0 auto' }}>
              <svg width="320" height="300" viewBox="0 0 320 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                {/* Browser window */}
                <rect x="20" y="80" width="200" height="150" rx="12" fill="white" />
                <rect x="20" y="80" width="200" height="30" rx="12" fill="#F8F9FA" />
                <rect x="20" y="100" width="200" height="10" fill="#F8F9FA" />
                <circle cx="35" cy="95" r="4" fill="#FF5F56" />
                <circle cx="50" cy="95" r="4" fill="#FFBD2E" />
                <circle cx="65" cy="95" r="4" fill="#27C93F" />

                {/* Login card inside browser */}
                <circle cx="120" cy="140" r="22" fill="#FFC107" />
                <path d="M120 135 C116 135 113 132 113 128 C113 124 116 121 120 121 C124 121 127 124 127 128 C127 132 124 135 120 135 Z" fill="#FFA000" />
                <path d="M105 155 C105 148 110 145 120 145 C130 145 135 148 135 155 L135 160 L105 160 Z" fill="#FFA000" />

                {/* Lines for password */}
                <rect x="80" y="175" width="80" height="12" rx="6" fill="#F1F3F4" />
                {[90, 105, 120, 135, 150].map(cx => <circle key={cx} cx={cx} cy="181" r="2.5" fill="#5F6368" />)}

                {/* Small button */}
                <rect x="80" y="195" width="80" height="18" rx="4" fill="#1A1A2E" />
                <text x="120" y="207" textAnchor="middle" fill="white" fontSize="10" fontWeight="bold">Sign In</text>

                {/* Shield icon - floating behind */}
                <path d="M230 40 L265 52 L265 80 C265 105 250 125 230 135 C210 125 195 105 195 80 L195 52 L230 40Z" fill="#3B82F6" stroke="#fff" strokeWidth="2" />
                <circle cx="230" cy="85" r="12" fill="white" />
                <path d="M222 85 L227 90 L238 78" stroke="#3B82F6" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />

                {/* Woman figure */}
                <path d="M220 150 L275 150 C290 150 300 160 300 175 L300 280 L220 280 Z" fill="#4361EE" /> {/* Dress/Body */}
                {/* Polka dots on dress */}
                {[
                  { x: 240, y: 170 }, { x: 260, y: 175 }, { x: 280, y: 170 },
                  { x: 235, y: 195 }, { x: 255, y: 200 }, { x: 275, y: 195 },
                  { x: 245, y: 220 }, { x: 265, y: 225 }, { x: 285, y: 220 },
                  { x: 235, y: 250 }, { x: 255, y: 255 }, { x: 275, y: 250 }
                ].map((dot, i) => <circle key={i} cx={dot.x} cy={dot.y} r="3" fill="rgba(255,255,255,0.4)" />)}

                <circle cx="260" cy="130" r="25" fill="#FFE0B2" /> {/* Head */}
                <path d="M235 125 C235 100 250 90 260 90 C270 90 285 100 285 125 C285 135 275 140 260 140 C245 140 235 135 235 125Z" fill="#1A1A2E" /> {/* Hair */}
                <rect x="220" y="270" width="80" height="30" fill="#1A1A2E" /> {/* Skirt/Lower body */}

                {/* Arm pointing */}
                <path d="M235 200 L185 220" stroke="#FFE0B2" strokeWidth="14" strokeLinecap="round" />
                <path d="M185 220 L170 220" stroke="#FFE0B2" strokeWidth="12" strokeLinecap="round" />
              </svg>
            </div>
          </div>
        </div>
        ...
        {/* Right panel */}
        <div style={{ flex: 1, padding: '50px 70px', display: 'flex', flexDirection: 'column', justifyContent: 'center', backgroundColor: '#fff' }}>
          ...
          <div style={{ marginBottom: '40px' }}>
            <h2 style={{ fontSize: '30px', fontWeight: '800', color: '#4361ee', marginBottom: '8px' }}>SIGN IN</h2>
            <p style={{ color: '#888ea8', fontSize: '14px' }}>Enter your email and password to login</p>
          </div>
          ...
          <p style={{ textAlign: 'center', fontSize: '14px', color: '#3b3f5c' }}>
            ...
            <span onClick={() => navigate('/signup')} style={{ color: '#4361ee', fontWeight: '700', cursor: 'pointer', textDecoration: 'none' }}>
              SIGN UP
            </span>
          </p>

          <p style={{ textAlign: 'center', fontSize: '12px', color: '#888ea8', marginTop: '40px' }}>
